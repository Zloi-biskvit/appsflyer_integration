...
def _insert_to_bd(data, destination_table, destination_uri):
    return PostgresqlAdapter.insert(data=data, destination_table=destination_table, destination_uri=destination_uri , on_duplicate='update')
